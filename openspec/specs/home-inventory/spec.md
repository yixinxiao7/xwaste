# home-inventory Specification

## Purpose

Provide the At Home screen tracking what the household owns: direct quantity adjustment, removal at zero, moving items back to the shopping list, direct adds, and propagation of changes to household members.
