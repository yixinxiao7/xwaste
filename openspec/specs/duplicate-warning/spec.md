...
Warn — never block — when a user adds or renames a shopping-list item whose normalized name matches something the household already has at home, stating the quantity on hand.
